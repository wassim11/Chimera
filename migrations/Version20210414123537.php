 ...
 */
final class Version20210414123537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE bday bday DATE NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `utilisateur` CHANGE bday bday DATE DEFAULT NULL, CHANGE photo photo TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
