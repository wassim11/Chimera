 ...
 */
final class Version20210422000327 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE mdp mdp VARCHAR(255) NOT NULL, CHANGE type type INT NOT NULL, CHANGE bday bday DATE NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `utilisateur` CHANGE mdp mdp VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, CHANGE type type INT DEFAULT NULL, CHANGE bday bday DATE DEFAULT NULL, CHANGE photo photo TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
